...
import ReduxMessageForm from "./MessageForm/MessageForm";
...
const Dialogs = (props) => {
    ...
    let addMessageText = (value) => {
        props.addMessage(value.messageText)
    }

    let renderForm = () => {
        if (props.stateForm === true) {
            return <ReduxMessageForm onSubmit={addMessageText} initialMessageText={props.initialMessageText} />
        }
    }
